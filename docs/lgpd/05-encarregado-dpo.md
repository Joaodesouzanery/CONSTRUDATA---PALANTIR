...
- **Registros e rastreabilidade.** Trilha de auditoria (`audit_log`) append-only, princípio do **menor privilégio**, **TLS** em trânsito, criptografia em repouso e política mínima de senha apoiam a demonstração de conformidade (*accountability* — art. 6º, X). Segundo fator e backup gerenciado seguem `06-politica-de-seguranca.md` §8 — não os cite a um titular ou à ANPD sem conferir lá.
