...
export function BimUploadModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-[#0f0f0f] border border-[#2a2a2a] rounded-xl w-full max-w-lg p-5 shadow-2xl">
        {/* Header */}
        ...
        {/* Tabs */}
        <div className="flex gap-1 mb-4 bg-[#1e1e1e] rounded-lg p-0.5">
          {TABS.map((t) => (
            <button
              key={t.key}
        ...
        {tab === 'dxf' && (
          <>
            <div className="bg-[#1e1e1e]/50 border border-[#2a2a2a] rounded-lg p-3 mb-3 space-y-1.5">
            ...
            <div
              ...
              className={cn(
                ...
                dxfDragging ? 'border-indigo-500 bg-indigo-500/10' : 'border-[#2a2a2a] hover:border-gray-500',
              )}
            >
        ...
        {tab === 'shapefile' && (
          <>
            <div
              ...
              className={cn(
                'border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors',
                dragging ? 'border-indigo-500 bg-indigo-500/10' : 'border-[#2a2a2a] hover:border-gray-500',
              )}
            >
        ...
        {tab === 'levantamento' && (
          <>
            <div className="bg-[#1e1e1e]/50 border border-[#2a2a2a] rounded-lg p-3 mb-3">
            ...
            <button
              ...
              className="flex items-center gap-2 w-full justify-center px-3 py-3 border-2 border-dashed border-[#2a2a2a] hover:border-indigo-500 rounded-lg text-[#a3a3a3] hover:text-indigo-300 text-sm transition-colors"
            >
              <FileText size={16} />
            ...
            {surveyPreview.length > 0 && (
              <div className="mt-3 bg-[#1e1e1e] rounded-lg p-2">
