          ...
          <div className="divide-y divide-[#2a2a2a]">
            ...
            {logs.map((log) => {
              ...
              return (
                <div
                  key={log.id}
                  className="grid grid-cols-5 px-4 py-3 text-sm items-center hover:bg-[#262626] transition-colors"
                >
                  ...
                  <div className="flex items-center justify-end">
                    {isEditing ? (
                      <input
                        ...
                        className="w-20 bg-[#0f0f0f] border border-[#f97316]/60 rounded px-1.5 py-0.5 text-xs text-[#f5f5f5] text-center focus:outline-none"
                        autoFocus
                      />
                    ) : (
