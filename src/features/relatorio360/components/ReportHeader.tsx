    ...
    <div className="flex flex-col border-b border-[#2a2a2a] bg-[#161616]">
      ...
      <div className="flex items-center justify-between px-3 sm:px-6 py-4 flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          {/* Date display */}
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#2a2a2a] bg-[#1e1e1e] text-[#a3a3a3] text-sm">
          ...
          <div className="flex items-center gap-1">
            <button
              onClick={goToPrevDay}
              className="flex items-center justify-center w-8 h-8 rounded-lg border border-[#2a2a2a] bg-[#1e1e1e] text-[#a3a3a3] hover:text-[#f97316] hover:border-[#f97316]/40 transition-colors"
              title="Dia anterior"
            >
              <ChevronLeft size={16} />
            </button>
            ...
            <input
              ...
              className="h-8 px-2 rounded-lg border border-[#2a2a2a] bg-[#1e1e1e] text-[#f5f5f5] text-xs font-mono focus:outline-none focus:border-[#f97316]/60 transition-colors"
              title="Ir para data"
            />
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg border text-xs font-medium transition-colors ${
              showPeriod
                ...
                : 'border-[#2a2a2a] bg-[#1e1e1e] text-[#a3a3a3] hover:text-[#f97316] hover:border-[#f97316]/40'
            }`}
          ...
          <button
            ...
            disabled={!report}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#2a2a2a] bg-[#1e1e1e] text-[#a3a3a3] text-xs font-medium hover:text-[#f97316] hover:border-[#f97316]/40 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
