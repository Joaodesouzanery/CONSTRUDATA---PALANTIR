  ...
  return (
    <div className="flex flex-col gap-4">
      {items.map((item) => {
        ...
        return (
          <div key={item.id} className="bg-[#1e1e1e] border border-[#2a2a2a] rounded-xl overflow-x-auto overflow-hidden">
            {/* Item header */}
            <div className="px-4 py-2.5 bg-[#262626] border-b border-[#2a2a2a] flex items-center gap-3">
                  ...
                  {itemMatches.map((m) => (
                    <tr
                      ...
                      className={cn(
                        ...
                        m.selected ? 'bg-[#f97316]/5' : 'hover:bg-[#262626]',
                      )}
                    >
                      ...
                      <td className="px-3 py-2">
                        <input
                          ...
                          className="w-full bg-[#161616] border border-[#1f3c5e] rounded px-2 py-1 text-[#f5f5f5] text-xs focus:outline-none focus:border-[#f97316]"
                        />
                      </td>
                    </tr>
                  ))}
  ...
  return (
    <div className="flex flex-col gap-4">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <input
              ...
              className="bg-[#161616] border border-[#1f3c5e] rounded px-3 py-1.5 text-[#f5f5f5] text-xs placeholder:text-[#555] focus:outline-none focus:border-[#f97316]"
              required
            />
            <input
              placeholder="Unidade"
            ...
            <input
              ...
              className="col-span-2 bg-[#161616] border border-[#1f3c5e] rounded px-3 py-1.5 text-[#f5f5f5] text-xs placeholder:text-[#555] focus:outline-none focus:border-[#f97316]"
              required
            />
            <input
      ...
      {customBase.length === 0 ? (
        ...
        <div className="bg-[#0f0f0f] border border-[#2a2a2a] rounded-xl overflow-x-auto overflow-hidden">
          <table className="w-full text-xs border-collapse">
            <thead>
            ...
            <tbody>
              {customBase.map((entry) => (
                <tr key={entry.code} className="border-t border-[#2a2a2a] hover:bg-[#262626] transition-colors">
    ...
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <button
          ...
          className="flex items-center gap-1 text-[10px] px-2.5 py-1 rounded border border-[#2a2a2a] text-[#6b6b6b] hover:text-[#f97316] hover:border-[#f97316]/40 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
      ...
      {/* Tab bar */}
      <div className="flex gap-1 bg-[#0f0f0f] border border-[#2a2a2a] rounded-lg p-1 self-start">
        {TABS.map((tab) => (
          <button
            key={tab.key}
