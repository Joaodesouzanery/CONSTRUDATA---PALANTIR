    ...
    <div className="bg-[#1e1e1e] border border-[#2a2a2a] rounded-xl p-4">
      ...
      <div className="overflow-x-auto">
        <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-auto max-h-[250px]" preserveAspectRatio="xMidYMid meet">
          ...
          {yTicks.map((v) => (
            <g key={v}>
              <line x1={PAD_L} y1={py(v)} x2={W} y2={py(v)} stroke="#2a2a2a" strokeWidth={0.5} strokeDasharray="4,3" />
...
export function WhatIfPanel() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Info banner */}
      <div className="bg-[#0f0f0f] border border-[#2a2a2a] rounded-xl px-4 py-3 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-1 px-3 py-1.5 rounded-lg border border-[#2a2a2a] text-[#6b6b6b] text-xs hover:text-[#ef4444] hover:border-[#ef4444]/40 transition-colors disabled:opacity-40"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-2 bg-[#1e1e1e] border border-[#2a2a2a] rounded-xl p-4 flex flex-col gap-3 max-h-[500px] overflow-y-auto">
          ...
          {leafActivities.map((act) => {
            ...
            return (
              <div key={act.id} className="bg-[#262626] rounded-lg px-3 py-2.5">
