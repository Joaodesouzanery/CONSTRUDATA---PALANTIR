...
export function EquipmentList() {
  ...
  return (
    <>
      {/* Search + filter */}
      <div className="flex flex-col gap-2 p-3 border-b border-[#303030] shrink-0">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#141414] border border-[#303030] rounded-lg pl-8 pr-3 py-2 text-xs text-[#f5f5f5] placeholder:text-[#3f3f3f] outline-none focus:border-[#f97316] transition-colors"
          />
        </div>
              ...
              <button
                ...
                className={cn(
                  ...
                  active
                    ...
                    : 'border-[#303030] text-[#6b6b6b] hover:border-[#1f3c5e] hover:text-[#a3a3a3]'
                )}
              >
                {dotColor && !active && (
                  <span
      ...
      {/* Footer count */}
      <div className="px-4 py-2 border-t border-[#303030] shrink-0 text-[10px] text-[#3f3f3f]">
