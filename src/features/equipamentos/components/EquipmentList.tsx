      ...
      <div className="flex flex-col gap-2 p-3 border-b border-[#2a2a2a] shrink-0">
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-[#0f0f0f] border border-[#2a2a2a] rounded-lg pl-8 pr-3 py-2 text-xs text-[#f5f5f5] placeholder:text-[#3f3f3f] outline-none focus:border-[#f97316] transition-colors"
          />
        </div>
              ...
              <button
                ...
                className={cn(
                  ...
                  active
                    ...
                    : 'border-[#2a2a2a] text-[#6b6b6b] hover:border-[#1f3c5e] hover:text-[#a3a3a3]'
                )}
              >
                {dotColor && !active && (
                  <span
