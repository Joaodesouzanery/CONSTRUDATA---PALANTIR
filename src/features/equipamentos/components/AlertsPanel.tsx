...
export function AlertsPanel() {
      ...
      <div className="border-t border-[#2a2a2a] bg-[#161616] shrink-0">
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <button
            ...
            className="flex items-center gap-1 text-[10px] px-2 py-1 rounded border border-[#2a2a2a] text-[#6b6b6b] hover:text-[#f97316] hover:border-[#f97316]/40 transition-colors"
          >
            <Plus size={10} />
            Adicionar Alerta
          </button>
      ...
      <div className="px-4 pb-3 border-t border-[#2a2a2a] pt-3">
        <div className="flex items-center gap-2 flex-wrap">
          <select
            ...
            className="bg-[#0f0f0f] border border-[#2a2a2a] rounded px-2 py-1 text-xs text-[#f5f5f5] outline-none focus:border-[#f97316]"
          >
          ...
          <input
            ...
            maxLength={200}
            className="flex-1 min-w-[160px] bg-[#0f0f0f] border border-[#2a2a2a] rounded px-2 py-1 text-xs text-[#f5f5f5] outline-none focus:border-[#f97316] placeholder:text-[#3f3f3f]"
          />
          <button
            onClick={handleAdd}
  ...
  return (
    <div
      className="border-t border-[#2a2a2a] bg-[#161616] shrink-0"
      style={{ overflow: 'hidden', maxHeight: open ? (showAdd ? 300 : 220) : 44, transition: 'max-height 0.2s ease' }}
    >
      {/* Toggle header */}
      <button
        onClick={() => setOpen((o) => !o)}
        className="w-full flex items-center justify-between px-6 h-11 hover:bg-[#1e1e1e] transition-colors shrink-0"
      >
          ...
          <button
            ...
            className={cn(
              ...
              showAdd
                ...
                : 'border-[#2a2a2a] text-[#6b6b6b] hover:text-[#f97316] hover:border-[#f97316]/40'
            )}
          >
            <Plus size={9} />
            Adicionar
              ...
              >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    'border-[#2a2a2a] text-[#6b6b6b] hover:border-[#22c55e] hover:text-[#22c55e]'
                  )}
                >
                  <Check size={9} />
                  OK
