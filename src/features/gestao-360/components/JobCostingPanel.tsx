...
function IndexGauge({ value, label }: { value: number; label: string }) {
  ...
  const track  = isDark ? '#1c3658' : '#e5e8ed'
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 flex flex-col gap-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-[#112240] rounded overflow-hidden">
    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-[#112240] border border-[#1c3658] rounded-xl p-4">
          ...
          <div className="flex gap-4 mt-3 pt-3 border-t border-[#1c3658]">
            {[
        ...
        {/* CPI/SPI gauges */}
        <div className="bg-[#112240] border border-[#1c3658] rounded-xl p-4 flex flex-col">
          ...
          {allPhases.map((phase) => {
            ...
            return (
              <div key={phase.id} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-[#112240] rounded overflow-hidden">
                  <div
