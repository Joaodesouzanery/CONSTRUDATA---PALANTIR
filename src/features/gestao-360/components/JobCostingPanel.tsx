...
function IndexGauge({ value, label }: { value: number; label: string }) {
  ...
  const track  = isDark ? '#2a2a2a' : '#e5e8ed'
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 flex flex-col gap-1">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1 h-3 bg-[#1f1f1f] rounded overflow-hidden">
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        {/* CPI/SPI gauges */}
        <div className="bg-[#222222] border border-[#2a2a2a] rounded-xl p-4 flex flex-col">
          ...
          {allPhases.map((phase) => {
            ...
            return (
              <div key={phase.id} className="flex items-center gap-3">
                ...
                <div className="flex-1 h-2 bg-[#1f1f1f] rounded overflow-hidden">
                  <div
