...
export function ObraDialog() {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-2xl rounded-2xl border border-[#2a2a2a] bg-[#1a1a1a] flex flex-col shadow-2xl"
            ...
            {!isNew ? (
              confirmDelete ? (
                <div className="flex items-center gap-2">
                  ...
                  <button type="button" onClick={() => setConfirmDelete(false)} className="text-xs px-2 py-1 rounded bg-[#252525] text-[#a3a3a3] hover:bg-[#2a2a2a]">Não</button>
                </div>
              ) : (
