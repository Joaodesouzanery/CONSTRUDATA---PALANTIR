    ...
    <div className="flex flex-col gap-4 px-4 py-3">
      ...
      <div className="rounded-xl border border-[#2a2a2a] overflow-hidden">
        <table className="w-full text-xs">
          ...
          <tbody>
            {types.map((t, i) => (
              <tr key={t.type} className={i < types.length - 1 ? 'border-b border-[#1f1f1f]' : ''}>
...
export function MapaAnalyticsPanel() {
  ...
  return (
    <div className="border-t border-[#2a2a2a] bg-[#171717]" style={{ maxHeight: 320, overflowY: 'auto' }}>
      {/* Tab bar */}
      <div className="flex items-center gap-0 px-4 pt-2 border-b border-[#2a2a2a] bg-[#141414]">
