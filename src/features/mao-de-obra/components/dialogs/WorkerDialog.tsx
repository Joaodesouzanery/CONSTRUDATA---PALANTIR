...
export function WorkerDialog({ onClose }: Props) {
  ...
  return (
    ...
    >
      <div className="bg-[#161616] border border-[#2a2a2a] rounded-xl w-full max-w-lg p-6 flex flex-col gap-4 my-auto">
            ...
            {form.certifications.map((cert, idx) => (
              <div key={cert.id} className="flex items-center gap-2 bg-[#1e1e1e] rounded-lg p-2">
                <select
                  ...
                  className="bg-[#1e1e1e] border border-[#1f3c5e] rounded px-2 py-1 text-xs text-[#f5f5f5] focus:outline-none"
                >
