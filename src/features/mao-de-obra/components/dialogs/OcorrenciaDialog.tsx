        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <label className="flex flex-col gap-1">
            ...
            <textarea
              ...
              className="bg-[#14294e] border border-[#1f3c5e] rounded-lg px-3 py-2 text-sm text-[#f5f5f5] focus:outline-none focus:border-[#2abfdc] resize-none"
              ...
              {crews.map((crew) => (
                <label key={crew.id} className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="rounded border-[#1f3c5e] bg-[#14294e] accent-[#2abfdc]"
                  />
