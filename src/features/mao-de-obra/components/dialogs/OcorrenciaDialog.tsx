        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <label className="flex flex-col gap-1">
            ...
            <textarea
              ...
              className="bg-[#222222] border border-[#3a3a3a] rounded-lg px-3 py-2 text-sm text-[#f5f5f5] focus:outline-none focus:border-[#f97316] resize-none"
              ...
              {crews.map((crew) => (
                <label key={crew.id} className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="rounded border-[#3a3a3a] bg-[#222222] accent-[#f97316]"
                  />
