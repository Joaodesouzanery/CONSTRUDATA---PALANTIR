      ...
      <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-5 grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2 flex justify-end gap-3 pt-2">
            <button type="button" onClick={onClose} className="px-4 py-2 rounded-lg border border-[#2a2a2a] text-[#6b6b6b] text-sm hover:text-[#f5f5f5] hover:border-[#3a3a3a]">
              Cancelar
            </button>
...
function ExpandedRow({ worker, crews }: { worker: Worker; crews: { id: string; name: string }[] }) {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 px-4 py-3 bg-[#1a1a1a] border-t border-[#2a2a2a] text-xs">
      <div>
...
export function FuncionariosPanel() {
  ...
  const selectClass = 'bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg px-3 py-1.5 text-[#f5f5f5] text-xs focus:outline-none focus:border-[#f97316]'
    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative flex-1 min-w-48">
          ...
          <input
            className="w-full bg-[#1a1a1a] border border-[#2a2a2a] rounded-lg pl-8 pr-3 py-1.5 text-[#f5f5f5] text-xs focus:outline-none focus:border-[#f97316]"
        ...
        <button onClick={exportCSV} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#2a2a2a] text-[#6b6b6b] text-xs hover:text-[#f5f5f5] hover:border-[#3a3a3a]">
              ...
              {filtered.map((w) => {
                ...
                return (
                  <>
                    <tr
                      key={w.id}
                      className="border-b border-[#2a2a2a] hover:bg-[#252525] cursor-pointer"
