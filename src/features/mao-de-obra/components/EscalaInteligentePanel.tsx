...
function ShiftDialog({ initial, workers, onSave, onDelete, onClose }: ShiftDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="bg-[#0e1f38] border border-[#1c3658] rounded-2xl w-full max-w-md">
        <div className="flex items-center justify-between p-4 border-b border-[#1c3658]">
        ...
        <form onSubmit={handleSubmit} className="p-4 flex flex-col gap-3">
          ...
          <div className="flex justify-between pt-1">
            ...
            <div className="flex gap-2 ml-auto">
              <button type="button" onClick={onClose} className="px-3 py-1.5 rounded-lg border border-[#1c3658] text-[#6b6b6b] text-xs hover:text-[#f5f5f5]">Cancelar</button>
...
function CLTSettingsModal({ settings, onSave, onClose }: { settings: CLTSettings; onSave: (s: Partial<CLTSettings>) => void; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="bg-[#0e1f38] border border-[#1c3658] rounded-2xl w-full max-w-sm">
        <div className="flex items-center justify-between p-4 border-b border-[#1c3658]">
        ...
        <div className="p-4 grid grid-cols-2 gap-3">
          ...
          <div className="col-span-2 flex justify-end gap-2 pt-1">
            <button onClick={onClose} className="px-3 py-1.5 rounded-lg border border-[#1c3658] text-[#6b6b6b] text-xs">Cancelar</button>
  ...
  return (
    <div className="overflow-x-auto">
      <table className="w-full text-xs border-collapse">
        ...
        <tbody>
          {workers.map((w) => (
            <tr key={w.id} className="border-t border-[#1c3658]">
              ...
              {dates.map((d) => {
                ...
                return (
                  <td
                    key={ymd}
                    className="px-1 py-1 text-center cursor-pointer hover:bg-[#162e50]"
        ...
        <div className="flex flex-col gap-2">
          {dayShifts.map((s) => {
            ...
            return (
              <div
                key={s.id}
                className="bg-[#112240] border border-[#1c3658] rounded-xl p-3 flex items-center gap-3 cursor-pointer hover:border-[#2abfdc]/30"
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2 flex-wrap">
        {/* View mode */}
        <div className="flex rounded-lg border border-[#1c3658] overflow-hidden">
        ...
        <div className="ml-auto flex gap-2">
          <button onClick={() => setShowSettings(true)} className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#1c3658] text-[#6b6b6b] text-xs hover:text-[#f5f5f5]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        {/* Main calendar/grid */}
        <div className="lg:col-span-2 bg-[#112240] border border-[#1c3658] rounded-xl p-4">
          {viewMode === 'month' && (
        ...
        <div className="bg-[#112240] border border-[#1c3658] rounded-xl p-4 flex flex-col gap-3">
          ...
          {/* Legend */}
          <div className="border-t border-[#1c3658] pt-3">
