...
export function EscalaInteligentePanel() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* POSTOS — a demanda: que cargo, em que frente, quantos.
          Estava numa aba separada, e a Escala (a oferta: quem, quando) estava nesta. Mas
          "Gerar Escala Automática", que fica logo abaixo, é alimentado 100% pelo cadastro de
          postos — eram entrada e saída do mesmo motor, em telas diferentes. Sem postos
          cadastrados, o gerador só produz folgas de domingo. */}
      <PostosPanel />

      {/* As Equipes saíram daqui para a aba Funcionários (25/08/2026).
          Elas não têm relação com turno nem com posto — servem para o RDO, e o vínculo do
          funcionário com a equipe já mora lá. Sem essa mudança, juntar Escala e Postos trocaria
          duas telas médias por uma de ~1.200 linhas com quatro assuntos diferentes. */}
