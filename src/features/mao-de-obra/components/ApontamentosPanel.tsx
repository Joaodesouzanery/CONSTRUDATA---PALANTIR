    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-lg border border-[#3a3a3a] text-[#f5f5f5] text-sm font-medium hover:bg-[#252525] transition-colors disabled:opacity-50"
        >
