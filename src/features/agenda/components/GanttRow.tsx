...
export function GanttRow({
  ...
  const rowBg         = index % 2 === 0 ? '#141414' : 'rgba(255,255,255,0.018)'
  const timelineWidth = viewParams.totalDays * viewParams.pixelsPerDay

  return (
    <div
      className="flex border-b border-[#303030]"
    ...
    >
      ...
      <div
        ...
        className="border-r border-[#303030] flex flex-col justify-center px-4 gap-1"
      >
