...
export function GanttTimeHeader() {
  ...
  return (
    <div
      ...
      className="border-b border-[#2a2a2a] bg-[#161616]"
    >
      ...
      <div className="flex" style={{ minWidth: totalWidth }}>
        ...
        <div
          ...
          className="border-r border-b border-[#2a2a2a] px-3 flex items-center"
        >
        ...
        {topSegments.map((seg, i) => (
          <div
            ...
            className="border-r border-b border-[#2a2a2a] px-3 flex items-center overflow-hidden"
          >
        ...
        {Array.from({ length: numCols }).map((_, i) => {
          ...
          return (
            <div
              ...
              className="border-r border-[#2a2a2a] flex items-center justify-center overflow-hidden"
            >
