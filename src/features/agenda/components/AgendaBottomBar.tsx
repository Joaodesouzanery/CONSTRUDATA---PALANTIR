...
export function AgendaBottomBar() {
  ...
  return (
    <div className="flex items-center gap-4 px-5 py-2.5 border-t border-[#2a2a2a] bg-[#1a1a1a] shrink-0">
      {/* Unscheduled badge */}
      ...
      <button className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[#f97316] text-white text-xs font-semibold hover:bg-[#ea6a00] transition-colors">
        <CheckCircle size={13} />
        Revisar alterações
      </button>
    </div>
