...
export function FluxoCaixaPanel() {
  ...
  if (entries.length === 0) {
    return <div className="flex-1 flex items-center justify-center text-gray-500 text-sm p-6">Adicione lançamentos para ver o fluxo de caixa.</div>
  }

  return (
    <div className="p-6 space-y-5 overflow-auto">
      <p className="text-xs text-gray-400 uppercase tracking-wider font-semibold">Fluxo de Caixa Mensal</p>
