...
export function ModulosOverviewSection() {
  return (
    <section id="modulos" style={{ background: '#0f0f0f', borderTop: '1px solid rgba(255,255,255,0.10)' }} className="py-32">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px" style={{ background: 'rgba(255,255,255,0.10)' }}>
          {MODULOS.map(({ icon: Icon, label, desc, href }) => (
            <a
              ...
              className="group p-6 flex flex-col gap-3 hover:bg-[#161616] transition-colors cursor-pointer"
            >
