...
export function ContactForm() {
  ...
  return (
    <section id="contato" style={{ background: '#161616', borderTop: '1px solid rgba(255,255,255,0.10)' }} className="py-32">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div style={{ border: '1px solid rgba(255,255,255,0.14)', background: '#0f0f0f' }}>
          {/* Form header */}
