...
export function DashboardPanel() {
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-[#1e1e1e] rounded-xl border border-[#2a2a2a]">
        <div className="flex items-center justify-between px-4 py-3 border-b border-[#2a2a2a] flex-wrap gap-3">
          ...
          <div className="flex gap-2 flex-wrap">
            <input
              ...
              className="bg-[#262626] border border-[#363636] rounded px-3 py-1.5 text-xs text-white placeholder-[#6b6b6b] focus:outline-none focus:border-[#f97316]/50"
            />
            <select
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value)}
              className="bg-[#262626] border border-[#363636] rounded px-3 py-1.5 text-xs text-white focus:outline-none focus:border-[#f97316]/50"
            >
                  ...
                  <tr key={t.code} className="hover:bg-gray-750 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-2">
                        <div className="flex-1 h-2 bg-[#262626] rounded-full overflow-hidden min-w-[60px]">
