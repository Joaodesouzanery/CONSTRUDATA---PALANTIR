      ...
      <div className="flex items-start justify-between gap-4 shrink-0">
        <div className="grid grid-cols-3 gap-3 flex-1">
          {kpis.map(({ label, value, color }) => (
            <div key={label} className="bg-[#0f0f0f] border border-[#2a2a2a] rounded-xl p-4 flex flex-col gap-1">
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            {forecasts.map((f) => {
              ...
              return (
                <>
                  <tr key={f.id} className="border-t border-[#2a2a2a] hover:bg-[#262626]/50 transition-colors">
                    ...
                    <td className="px-3 py-2.5 text-center">
                      <div className="flex items-center justify-center gap-1 flex-wrap">
                        <button
                          ...
                          className="px-2 py-0.5 rounded bg-[#1e1e1e] hover:bg-[#262626] text-[#a3a3a3] text-[10px] font-semibold transition-colors"
                        >
                          Editar
                        </button>
                        {f.status === 'suggested' ? (
                          <>
                            ...
                            <button
                              ...
                              className="px-2 py-0.5 rounded bg-[#1f3c5e] hover:bg-[#2a2a2a] text-[#6b6b6b] text-[10px] font-semibold transition-colors"
                            >
                              Descartar
                            </button>
                          </>
                  ...
                  {editingId === f.id && (
                    <tr key={`${f.id}-edit`} className="border-t border-[#2a2a2a]">
