      ...
      <div className="bg-[#14294e] border border-[#20406a] rounded-xl p-4">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            disabled={!activityId}
            className="flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-medium bg-[#2abfdc] text-white hover:bg-[#2abfdc]/80 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
          >
      ...
      {simulations.length === 0 && (
        <div className="flex items-center justify-center flex-1 min-h-[200px]">
          <div className="text-center">
            <Play size={32} className="text-[#20406a] mx-auto mb-2" />
      ...
      {simulations.map((sim) => (
        <div key={sim.id} className={cn('border rounded-xl p-4', resultBg(sim.resultado.resultado))}>
          ...
          {sim.resultado.itensInsuficientes.length > 0 && (
            <div className="bg-[#0d2040]/50 rounded-lg overflow-hidden">
              <table className="w-full text-[11px]">
                ...
                <tbody>
                  {sim.resultado.itensInsuficientes.map((it) => (
                    <tr key={it.itemId} className="border-t border-[#20406a]">
