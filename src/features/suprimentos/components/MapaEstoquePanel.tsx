...
function StatusBar({ disponivel, minimo }: { disponivel: number; minimo: number }) {
  ...
  return (
    <div className="flex items-center gap-1">
      <div className="h-1.5 w-16 rounded-full bg-[#20406a]">
  ...
  return (
    <div className="flex flex-col gap-4 flex-1 min-h-0 overflow-y-auto pr-1">
        ...
        {depositos.filter((d) => d.ativo).map((d) => (
          <button
            ...
            className={cn(
              ...
              d.id === depId
                ? 'bg-[#2abfdc]/15 text-[#2abfdc] border-[#2abfdc]/40'
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {[
          { label: 'Total Itens',   value: totalItens,                              color: 'text-[#f5f5f5]',  bg: 'bg-[#14294e] border-[#20406a]' },
      ...
      <div className="flex gap-2 flex-wrap">
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-[#2abfdc]/15 text-[#2abfdc] border border-[#2abfdc]/30 hover:bg-[#2abfdc]/25 transition-colors"
        >
          <Plus size={13} /> Novo Item
        </button>
        <button
          onClick={() => setShowMovForm((v) => !v)}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium border border-[#20406a] text-[#6b6b6b] hover:text-[#a3a3a3] transition-colors"
        >
      ...
      {/* Novo Item form */}
      {showNovoItem && (
        <div className="bg-[#14294e] border border-[#20406a] rounded-xl p-4 grid grid-cols-2 sm:grid-cols-3 gap-3">
          {[
            ...
            <div key={key} className={span ? 'col-span-2 sm:col-span-3' : ''}>
              ...
              <input
                ...
                className="w-full bg-[#0d2040] border border-[#20406a] rounded-lg px-2.5 py-1.5 text-xs text-[#f5f5f5] focus:outline-none focus:border-[#2abfdc]/50"
              />
            </div>
          ))}
          <div className="col-span-2 sm:col-span-3 flex gap-2 justify-end">
            ...
            <button onClick={handleSaveNovoItem} className="px-4 py-1.5 text-xs font-medium bg-[#2abfdc] text-white rounded-lg hover:bg-[#2abfdc]/80">Salvar</button>
          </div>
        </div>
      )}
      ...
      {showMovForm && (
        <div className="bg-[#14294e] border border-[#20406a] rounded-xl p-4 grid grid-cols-2 sm:grid-cols-3 gap-3">
          ...
          <div className="col-span-2 sm:col-span-3 flex gap-2 justify-end">
            ...
            <button onClick={handleSaveMov} className="px-4 py-1.5 text-xs font-medium bg-[#2abfdc] text-white rounded-lg hover:bg-[#2abfdc]/80">Registrar</button>
          </div>
        </div>
      )}
      ...
      <div className="bg-[#14294e] border border-[#20406a] rounded-xl overflow-hidden">
        <div className="px-4 py-2.5 border-b border-[#20406a] flex items-center gap-2">
          <Package size={14} className="text-[#2abfdc]" />
          ...
          <table className="w-full text-[11px]">
            ...
            <tbody>
              {itens.map((item: ItemEstoque) => (
                <tr key={item.id} className="border-t border-[#20406a] hover:bg-[#1a3662]/30 transition-colors">
                  ...
                  <td className="px-3 py-2 font-mono">
                    {item.qtdTransito > 0
                      ? <span className="text-[#2abfdc]">{item.qtdTransito}</span>
      ...
      <div className="bg-[#14294e] border border-[#20406a] rounded-xl overflow-hidden">
        <div className="px-4 py-2.5 border-b border-[#20406a]">
