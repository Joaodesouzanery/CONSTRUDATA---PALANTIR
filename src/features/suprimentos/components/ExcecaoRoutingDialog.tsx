    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div className="bg-[#1e1e1e] border border-[#2a2a2a] rounded-xl w-full max-w-md">
        ...
        <div className="p-5 flex flex-col gap-4">
          {/* Description */}
          <div className="bg-[#262626] rounded-lg p-3 text-[#a3a3a3] text-xs leading-relaxed">
          ...
          <div className="flex flex-col gap-1">
            ...
            <textarea
              ...
              className="w-full bg-[#161616] border border-[#1f3c5e] rounded px-3 py-2 text-[#f5f5f5] text-sm focus:outline-none focus:border-[#f97316] resize-none"
            />
          </div>
