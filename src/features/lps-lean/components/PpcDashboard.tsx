  ...
  return (
    <div className="p-6 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-2">
            {trend > 0
              ...
              : trend < 0
                ...
                : <span className="text-[#6b6b6b] text-lg">—</span>}
            <span className={`text-lg font-bold ${trend > 0 ? 'text-green-400' : trend < 0 ? 'text-red-400' : 'text-[#a3a3a3]'}`}>
      ...
      <div className="grid grid-cols-5 gap-4">
        {/* Bar chart — 3/5 */}
        <div className="col-span-3 rounded-xl border border-[#1e1e1e] bg-[#0f0f0f] p-4">
          ...
          <div className="flex items-center gap-4 mt-2 text-[10px] text-[#6b6b6b]">
        ...
        {/* Pareto CNC — 2/5 */}
        <div className="col-span-2 rounded-xl border border-[#1e1e1e] bg-[#0f0f0f] p-4">
        ...
        <table className="w-full text-xs">
          <thead className="bg-[#1e1e1e]/80 border-b border-[#2a2a2a]">
            <tr>
              ...
              <th className="text-right text-[#a3a3a3] px-4 py-2.5 font-semibold">Concluídas</th>
          ...
          <tbody className="divide-y divide-[#1e1e1e]">
            {[...weekly].reverse().slice(0, 8).map((w) => (
              <tr key={w.week} className="bg-[#0f0f0f] hover:bg-[#1e1e1e]/60">
