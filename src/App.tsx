    ...
    <BrowserRouter>
      <Routes>
        <Route element={<AppShell />}>
          <Route index element={<Navigate to="/gestao-360" replace />} />
          <Route path="/relatorio360"        element={<Relatorio360Page />} />
          <Route path="/agenda"              element={<AgendaPage />} />
          <Route path="/equipamentos"        element={<Navigate to="/gestao-equipamentos" replace />} />
          ...
          <Route path="*"                    element={<Navigate to="/gestao-360" replace />} />
        </Route>
      </Routes>
    </BrowserRouter>
  )
