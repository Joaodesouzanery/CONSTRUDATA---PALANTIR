...
const FluxogramaPage        = lazy(() => import('@/features/fluxograma/index').then((m) => ({ default: m.FluxogramaPage })))
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/app" element={<AppShell />}>
          ...
          <Route path="fluxograma"         element={<LazyRoute><FluxogramaPage /></LazyRoute>} />
