...
const TUTORIAL_CONTENT: Record<string, string> = {
  ...
  '/app/planejamento-mestre': 'WBS, marcos e baselines + metodologia LPS/Lean integrada: Takt (Longo), look-ahead 6 semanas e restrições (Médio), semáforo/mão de obra (Curto), PPC e Pareto de causas (Semanal).',
